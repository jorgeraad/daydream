...
- **20260212172321 - Migrate TitleScreen + OnboardingScreen** — Replace manual buffer management with GameInput/MaskedInput | Touches: `apps/game/src/TitleScreen.ts`, `apps/game/src/OnboardingScreen.ts`
